...
import {
  ...
  Star, Settings, LogOut, Dumbbell, X, Search, Bell, Calendar, MessageCircle, HelpCircle, MessageSquare
} from 'lucide-react';
 ...
 */
const DashboardSidebar = ({ isOpen, onClose, onOpenFeedback }) => {
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Main Nav */}
            <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto outline-none">
            ...
            <div className="px-3 py-4 border-t border-slate-100 dark:border-dark-border space-y-1">
              <p className="text-[10px] font-bold text-slate-400 dark:text-slate-600 uppercase tracking-widest px-3 mb-3">Support</p>
